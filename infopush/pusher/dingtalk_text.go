...
func SendDingTalkText(configData map[string]any, params map[string]string) (string, error) {
	// 转换配置
...
func convertToDingTalkTextConfig(config map[string]any) (DingTalkTextConfig, error) {
	// 使用类型断言提取配置值

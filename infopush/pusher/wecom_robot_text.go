...
func convertToWecomRobotTextConfig(configData map[string]any) (*WecomRobotTextConfig, error) {
	...
	if keysInterface, ok := configData["Keys"].([]any); ok {
...
func SendWecomRobotText(configData map[string]any, params map[string]string) (string, error) {
